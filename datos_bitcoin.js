...
getUrlContent('https://mindicador.cl/api/bitcoin')
    .then(function (valor_bit) {

        // Al funcionar correctamente, desplegar el resultado
        // y luego generar el CSV de salida
        console.log("*********** Valores obtenidos ***********");
        console.log(valor_bit.serie.length);

        console.log("*********** Contenido en posición 3 ***********");
        console.log(valor_bit.serie[3]);
        console.log("*********** Valor en posición 3 ***********");
        console.log(valor_bit.serie[3].valor);
        console.log("****************************************************");
        ...
        for (let indice = 0; indice < valor_bit.serie.length; indice++) {
            ...
            if (isNaN(valores_dia[fecha])) {
                ...
                valores_dia[fecha] = valor_bit.serie[indice].valor;
            } 
        }
        ...
        */
        ...
        const archivo_csv = createObjectCsvWriter({
            path: "./bitcoin.csv", // acá indicamos donde se grabará el archivo
            header: [
                { id: "dia", title: "DATE" },
                { id: "valor", title: "QTY" }
            ]
