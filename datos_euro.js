...
getUrlContent('https://mindicador.cl/api/euro')
    .then(function (valor_euro) {

        // Al funcionar correctamente, desplegar el resultado
        // y luego generar el CSV de salida
        console.log("*********** Valores obtenidos ***********");
        console.log(valor_euro.serie.length);

        console.log("*********** Contenido en posición 3 ***********");
        console.log(valor_euro.serie[3]);
        console.log("*********** Valor en posición 3 ***********");
        console.log(valor_euro.serie[3].valor);
        console.log("****************************************************");
        ...
        for (let indice = 0; indice < valor_euro.serie.length; indice++) {
            ...
            if (isNaN(valores_dia[fecha])) {
                ...
                valores_dia[fecha] = valor_euro.serie[indice].valor;
            } 
        }
        ...
        */
        ...
        const archivo_csv = createObjectCsvWriter({
            path: "./euro.csv", // acá indicamos donde se grabará el archivo
            header: [
                { id: "dia", title: "DATE" },
                { id: "valor", title: "QTY" }
            ]
